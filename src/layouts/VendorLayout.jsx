        ...
        children: [
            ...
            /*#__PURE__*/ _jsxs("aside", {
                ...
                children: [
                    /*#__PURE__*/ _jsx("div", {
                        className:
                            "flex h-16 items-center justify-center px-4 bg-aorbo-teal",
                        ...
                        children: [
                            /*#__PURE__*/ _jsxs(Link, {
                                ...
                                className: `group flex items-center px-4 py-3 rounded-md transition-all ${
                                    isActive("/vendor") &&
                                    !isActive("/vendor/treks") &&
                                    !isActive("/vendor/bookings") &&
                                    !isActive("/vendor/customers") &&
                                    ...
                                    !isActive("/vendor/destinations") &&
                                    !isActive("/vendor/withdrawals") &&
                                    !isActive("/vendor/coupons")
                            ...
                            /*#__PURE__*/ _jsxs("button", {
                                ...
                                className:
                                    "w-full group flex items-center px-4 py-3 text-white hover:bg-white hover:bg-opacity-10 rounded-md transition-all",
                                children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ _jsxs("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ _jsx("div", {
                                        className:
                                            "h-8 w-8 rounded-full bg-aorbo-teal text-white flex items-center justify-center",
                                        children: /*#__PURE__*/ _jsx("span", {
