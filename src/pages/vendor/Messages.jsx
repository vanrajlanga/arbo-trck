          ...
          {selectedConversation ? (
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-3">
                {MESSAGES.map((message) => (
                  ...
                  >
                    <div className={`max-w-[80%] ${message.isUser ? 'bg-blue-500 text-white rounded-tl-lg rounded-br-lg rounded-bl-lg' : 'bg-gray-100 text-gray-800 rounded-tr-lg rounded-br-lg rounded-bl-lg'} px-4 py-2`}>
                      <div className="text-sm">{message.content}</div>
                      <div className={`text-xs mt-1 ${message.isUser ? 'text-blue-100' : 'text-gray-500'}`}>{message.timestamp}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                <div className="text-gray-400 mb-2">Select a conversation to start chatting</div>
              </div>
            </div>
          )}
        </Card>
