            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className={`text-xs mt-1 flex items-center ${card.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}>
                    {card.change} <span className="text-gray-500 ml-1">{card.timeframe}</span>
                  </p>
                </div>
        ...
        <TabsContent value="bookings">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View your booking trends and revenue generation</CardDescription>
            </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Month-wise booking trend analysis</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="bookings" name="Bookings" stroke="#8884d8" activeDot={{ r: 8 }} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Month-wise revenue analysis</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Comparison of trek bookings</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      >
                        {trekPopularityData.map((entry, index) => (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Revenue generation by trek</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="bookings" name="New Customers" stroke="#FF8042" activeDot={{ r: 8 }} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
