      ...
      <div className="flex-1 flex flex-col justify-center px-4 py-12 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-center text-gray-600">
            Or{" "}
            <Link to="/register" className="font-medium text-aorbo-teal hover:text-aorbo-teal/90">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-medium text-aorbo-teal hover:text-aorbo-teal/90">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-1 gap-3">
                <div className="text-sm text-center">
                  <p className="text-gray-500 mb-2">You can use these demo accounts:</p>
                  <p className="font-medium">Admin: admin@aorbo.com / password</p>
                  <p className="font-medium">Vendor: vendor@aorbo.com / password</p>
                </div>
              </div>
            </div>
          </div>
