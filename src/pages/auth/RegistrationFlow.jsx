    ...
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="border-t border-gray-200 pt-6">
          ...
          <p className="text-sm text-center font-medium mb-4">Noteease verify your information thoroughly, submitted, it will be locked and processed by Aorbo.</p>
        </div>
...
const RegistrationFlow = () => {
  ...
  const steps = [
    { id: 1, name: "Personal Details", iconer },
    { id: 2, name: "Bank Details", iconnknoteIcon },
    { id: 3, name: "GST Details", iconfo },
    { id: 4, name: "Upload Documents", iconleText },
    { id: 5, name: "Success", iconeck }
  ];
