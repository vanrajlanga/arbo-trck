            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-500">
                        Insights and statistics across the platform.
                    </p>
                </div>
                ...
                <TabsContent value="overview" className="space-y-6">
                    <Card className="mt-6">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Monthly revenue trend over the past 6 months
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Distribution of treks by category
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="h-[300px]">
                ...
                <TabsContent value="bookings" className="space-y-6">
                    <Card className="mt-6">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Detailed booking statistics and trends
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <TabsContent value="treks" className="space-y-6">
                    <Card className="mt-6">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Insights into trek performance and popularity
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <TabsContent value="vendors" className="space-y-6">
                    <Card className="mt-6">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Performance metrics for vendors on the platform
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start space-x-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Summit Seekers joined the platform
                                </p>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Mountain Explorers added "Himalayan Summit
                                    Challenge"
                                </p>
                                <p className="text-xs text-muted-foreground">
                                    5 hours ago
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Platform crossed ₹10 Lakhs in monthly
                                    revenue
                                </p>
                                <p className="text-xs text-muted-foreground">
                                    12 hours ago
