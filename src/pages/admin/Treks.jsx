...
const AdminTreks = () => {
  ...
  const filteredTreks = treks.filter(trek => {
    const matchesSearch = trek.name.toLowerCase().includes(searchTerm.toLowerCase()) || trek.destination.toLowerCase().includes(searchTerm.toLowerCase()) || trek.description.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  return /*#__PURE__*/_jsxs("div", {
    children: [/*#__PURE__*/_jsx("div", {
          ...
          children: [/*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsx(Users, {
              ...
              children: [/*#__PURE__*/_jsx(SelectTrigger, {
                ...
                }), vendors.map(vendor => /*#__PURE__*/_jsx(SelectItem, {
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsxs(Table, {
            children: [/*#__PURE__*/_jsx(TableHeader, {
              ...
              children: loading ? /*#__PURE__*/_jsx(TableRow, {
                children: /*#__PURE__*/_jsx(TableCell, {
                  colSpan: 7,
                  className: "text-center py-8",
                  children: "Loading treks..."
                })
              }) : filteredTreks.length > 0 ? filteredTreks.map(trek => /*#__PURE__*/_jsxs(TableRow, {
                children: [/*#__PURE__*/_jsx(TableCell, {
                  className: "font-medium",
                  children: trek.name
                }), /*#__PURE__*/_jsx(TableCell, {
                  children: trek.vendorName
                }), /*#__PURE__*/_jsx(TableCell, {
                  ...
                  children: /*#__PURE__*/_jsx(Badge, {
                    className: trek.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800',
                    children: trek.status === 'active' ? 'Active' : 'Draft'
                  })
                }), /*#__PURE__*/_jsx(TableCell, {
                  className: "text-right",
                  children: /*#__PURE__*/_jsx(Button, {
                    variant: "ghost",
                    size: "icon",
                    onClick: () => viewTrekDetails(trek),
                    children: /*#__PURE__*/_jsx(Eye, {
                      className: "h-4 w-4"
                    })
                  })
                })]
              }, trek.id)) : /*#__PURE__*/_jsx(TableRow, {
                children: /*#__PURE__*/_jsx(TableCell, {
                  colSpan: 7,
                  className: "text-center py-8",
                  children: "No treks found matching your filters."
                })
              })
            })]
          })
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsxs(Table, {
            children: [/*#__PURE__*/_jsx(TableHeader, {
              ...
              children: loading ? /*#__PURE__*/_jsx(TableRow, {
              ...
              }) : filteredTreks.filter(trek => trek.status === 'active').length > 0 ? filteredTreks.filter(trek => trek.status === 'active').map(trek => /*#__PURE__*/_jsxs(TableRow, {
                children: [/*#__PURE__*/_jsx(TableCell, {
                  className: "font-medium",
                  children: trek.name
                }), /*#__PURE__*/_jsx(TableCell, {
                ...
                children: /*#__PURE__*/_jsx(TableCell, {
                  colSpan: 7,
                  className: "text-center py-8",
                  children: "No active treks found."
                })
              })
            })]
          })
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsxs(Table, {
            children: [/*#__PURE__*/_jsx(TableHeader, {
              ...
              }) : filteredTreks.filter(trek => trek.status === 'draft').length > 0 ? filteredTreks.filter(trek => trek.status === 'draft').map(trek => /*#__PURE__*/_jsxs(TableRow, {
                children: [/*#__PURE__*/_jsx(TableCell, {
                  className: "font-medium",
                  children: trek.name
                }), /*#__PURE__*/_jsx(TableCell, {
      ...
      children: /*#__PURE__*/_jsxs(DialogContent, {
        ...
        }), selectedTrek && /*#__PURE__*/_jsxs("div", {
          className: "space-y-6",
          children: [/*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsx("img", {
              ...
              children: /*#__PURE__*/_jsx(Badge, {
                className: selectedTrek.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800',
                children: selectedTrek.status === 'active' ? 'Active' : 'Draft'
              })
            })]
          }), /*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsxs("div", {
              children: [/*#__PURE__*/_jsx("h3", {
                ...
                className: "flex items-center text-gray-500 text-sm mb-1",
                ...
                children: [/*#__PURE__*/_jsx(Users, {
                  className: "h-4 w-4 mr-1"
                }), " Vendor: ", selectedTrek.vendorName]
              }), /*#__PURE__*/_jsx("p", {
                className: "text-gray-600 mb-4",
                children: selectedTrek.description
              })]
            }), /*#__PURE__*/_jsxs("div", {
              ...
              children: [/*#__PURE__*/_jsxs("div", {
                ...
                children: [/*#__PURE__*/_jsx("h4", {
                  ...
                  children: selectedTrek.duration
                })]
              }), /*#__PURE__*/_jsxs("div", {
                className: "bg-gray-50 p-4 rounded-md",
                children: [/*#__PURE__*/_jsx("h4", {
                  ...
                  children: selectedTrek.difficulty
                })]
              }), /*#__PURE__*/_jsxs("div", {
                className: "bg-gray-50 p-4 rounded-md",
                children: [/*#__PURE__*/_jsx("h4", {
                  ...
                  children: ["\u20B9", selectedTrek.price, "/person"]
                })]
              }), /*#__PURE__*/_jsxs("div", {
                className: "bg-gray-50 p-4 rounded-md",
                children: [/*#__PURE__*/_jsx("h4", {
                  ...
                  children: [selectedTrek.slots.booked, "/", selectedTrek.slots.total]
                })]
              })]
            })]
            ...
            children: [/*#__PURE__*/_jsx("h3", {
              ...
              className: "space-y-4",
              children: selectedTrek.itinerary?.map((day, index) => /*#__PURE__*/_jsxs("div", {
                ...
                children: [/*#__PURE__*/_jsxs("h4", {
                  ...
                  children: day.activities.map((activity, actIdx) => /*#__PURE__*/_jsx("li", {
            ...
            children: [/*#__PURE__*/_jsxs("div", {
              children: [/*#__PURE__*/_jsx("h3", {
                ...
                className: "list-disc list-inside space-y-1",
                children: selectedTrek.inclusions?.map((item, idx) => /*#__PURE__*/_jsx("li", {
                  className: "text-gray-600",
                  children: item
                }, idx))
              })]
              ...
              children: [/*#__PURE__*/_jsx("h3", {
                ...
                className: "list-disc list-inside space-y-1",
                children: selectedTrek.exclusions?.map((item, idx) => /*#__PURE__*/_jsx("li", {
                  className: "text-gray-600",
                  children: item
                }, idx))
              })]
            ...
            children: [/*#__PURE__*/_jsx("h3", {
              ...
              children: [/*#__PURE__*/_jsxs("div", {
                children: [/*#__PURE__*/_jsx("h4", {
                  ...
                  children: selectedTrek.meetingPoint || 'Not specified'
                })]
              }), /*#__PURE__*/_jsxs("div", {
                children: [/*#__PURE__*/_jsx("h4", {
                  className: "text-sm font-medium text-gray-500 mb-1",
                  ...
                  children: selectedTrek.meetingTime || 'Not specified'
                })]
              })]
            })]
          }), /*#__PURE__*/_jsx("div", {
