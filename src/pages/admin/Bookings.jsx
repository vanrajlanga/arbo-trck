...
const AdminBookings = () => {
  ...
  const filteredBookings = bookings.filter(booking => {
    const matchesSearch = booking.customer.name.toLowerCase().includes(searchTerm.toLowerCase()) || booking.trek.name.toLowerCase().includes(searchTerm.toLowerCase()) || booking.id.toLowerCase().includes(searchTerm.toLowerCase());
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsxs(Table, {
            children: [/*#__PURE__*/_jsx(TableHeader, {
              ...
              }) : filteredBookings.length > 0 ? filteredBookings.map(booking => /*#__PURE__*/_jsxs(TableRow, {
                children: [/*#__PURE__*/_jsx(TableCell, {
                  ...
                  children: booking.trek.name
                }), /*#__PURE__*/_jsx(TableCell, {
                  children: booking.vendor.name
                }), /*#__PURE__*/_jsx(TableCell, {
                  children: booking.trekDate
                }), /*#__PURE__*/_jsx(TableCell, {
              ...
              }, booking.id)) : /*#__PURE__*/_jsx(TableRow, {
                children: /*#__PURE__*/_jsx(TableCell, {
                  colSpan: 8,
                  className: "text-center py-8",
                  children: "No bookings found matching your filters."
                })
              })
            })]
          })
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsxs(Table, {
            children: [/*#__PURE__*/_jsx(TableHeader, {
              ...
              children: loading ? /*#__PURE__*/_jsx(TableRow, {
              ...
              }) : filteredBookings.filter(booking => booking.status === 'confirmed').length > 0 ? filteredBookings.filter(booking => booking.status === 'confirmed').map(booking => /*#__PURE__*/_jsxs(TableRow, {
                children: [/*#__PURE__*/_jsx(TableCell, {
                  className: "font-medium",
                  children: booking.id
                }), /*#__PURE__*/_jsx(TableCell, {
                ...
                children: /*#__PURE__*/_jsx(TableCell, {
                  colSpan: 8,
                  className: "text-center py-8",
                  children: "No confirmed bookings found."
                })
              })
            })]
          })
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsxs(Table, {
            children: [/*#__PURE__*/_jsx(TableHeader, {
              ...
              children: loading ? /*#__PURE__*/_jsx(TableRow, {
              ...
              }) : filteredBookings.filter(booking => booking.status === 'pending').length > 0 ? filteredBookings.filter(booking => booking.status === 'pending').map(booking => /*#__PURE__*/_jsxs(TableRow, {
                children: [/*#__PURE__*/_jsx(TableCell, {
                  className: "font-medium",
                  children: booking.id
                }), /*#__PURE__*/_jsx(TableCell, {
                ...
                children: /*#__PURE__*/_jsx(TableCell, {
                  colSpan: 8,
                  className: "text-center py-8",
                  children: "No pending bookings found."
                })
              })
            })]
          })
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsxs(Table, {
            children: [/*#__PURE__*/_jsx(TableHeader, {
              ...
              children: loading ? /*#__PURE__*/_jsx(TableRow, {
              ...
              }) : filteredBookings.filter(booking => !['confirmed', 'pending'].includes(booking.status)).length > 0 ? filteredBookings.filter(booking => !['confirmed', 'pending'].includes(booking.status)).map(booking => /*#__PURE__*/_jsxs(TableRow, {
                children: [/*#__PURE__*/_jsx(TableCell, {
                  className: "font-medium",
                  children: booking.id
                }), /*#__PURE__*/_jsx(TableCell, {
                ...
                children: /*#__PURE__*/_jsx(TableCell, {
                  colSpan: 8,
                  className: "text-center py-8",
                  children: "No other bookings found."
                })
              })
            })]
          })
      ...
      children: /*#__PURE__*/_jsxs(DialogContent, {
        ...
        children: [/*#__PURE__*/_jsx(DialogHeader, {
          children: /*#__PURE__*/_jsxs(DialogTitle, {
            children: ["Booking Details - ", selectedBooking?.id]
          })
            ...
            children: [/*#__PURE__*/_jsxs("div", {
              ...
              children: [/*#__PURE__*/_jsxs("div", {
                ...
                children: [/*#__PURE__*/_jsx("h3", {
                  ...
                  }), selectedBooking.notes && /*#__PURE__*/_jsxs("p", {
                    children: [/*#__PURE__*/_jsx("span", {
                      className: "font-medium",
                      children: "Notes:"
              ...
              children: [/*#__PURE__*/_jsxs("div", {
                children: [/*#__PURE__*/_jsx("h3", {
                  ...
                  children: [/*#__PURE__*/_jsx("div", {
                    className: "h-40 rounded-md overflow-hidden mb-4",
                    ...
                    children: selectedBooking.trek.name
                  }), /*#__PURE__*/_jsxs("div", {
                ...
                children: [/*#__PURE__*/_jsx("h3", {
                  ...
                  children: [/*#__PURE__*/_jsx("h4", {
                    className: "font-medium",
                    children: selectedBooking.vendor.name
                  }), /*#__PURE__*/_jsxs("p", {
                    className: "text-sm text-gray-500",
                    children: ["Vendor ID: ", selectedBooking.vendor.id]
                  })]
                })]
              })]
            })]
