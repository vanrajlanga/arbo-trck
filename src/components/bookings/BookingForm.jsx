...
const BookingForm = ({ onSubmit, isOpen, onClose }: BookingFormProps) => {
    ...
    const fetchData = () => {
      try {
        ...
        if (treksJson) {
          ...
          const formattedTreks = parsedTreks.map((trek: any) => ({
  ...
  const handleTrekChange = (trekId: string) => {
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <Input 
                ...
                onChange={(e) => setBooking({...booking, amount: Number(e.target.value)})}
